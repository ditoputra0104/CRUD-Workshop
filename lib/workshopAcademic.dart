...
class WorkshopAcademic extends StatefulWidget {
  const WorkshopAcademic({super.key});

  @override
  State<WorkshopAcademic> createState() => _WorkshopAcademicState();
}

class _WorkshopAcademicState extends State<WorkshopAcademic> {
  String searchQuery = "";
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Filter buttons (optional functionality)
          Padding(
